function[] = main_latent_cluster2(id)
id = str2num(id);
...
%%%Lambdas[12] is zero.
funObj = @(V0)Compute_SGD_latent_fast2(V0,indexSet,TrainSamples, Q, all_phi_full_matrix,usingTrainingSample,videosToIndex,Lambdas(id));
disp('start');
V0 = W0;
...
save([output_path,'latentDownSample_',num2str(Lambdas(id))],'W_MSSV');
